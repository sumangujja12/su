...
public class Fastdata_Notescancel {
WebDriver driver;
	...
	@Given ("Select Create Notes Cancel option from Favorite chart in Fastdatachart screen")
	public void Engineovw() throws Exception {
		...
		st.Notescancel();
		Thread.sleep(8000);
		System.out.print("Favoritelist is Creation cancelled");
