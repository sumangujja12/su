...
import pages.Cloud.DataReportingpage;
...
WebDriver driver;
	...
	//@Test
	@Given ("Select Favorite item form Data Reporting screen")
	public void Engineovw() throws Exception {
		...
		sp.submitLogin();
		Thread.sleep(30000);
		DataReportingpage st=new DataReportingpage(driver);
		st.Datareportingicon();
		Thread.sleep(5000);	
		st.favoritedatareport();
		Thread.sleep(5000);
		st.favoritedatareporttext();
		Thread.sleep(5000);
		driver.close();
