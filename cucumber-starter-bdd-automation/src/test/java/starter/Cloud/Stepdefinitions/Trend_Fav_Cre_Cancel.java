...
public class Trend_Fav_Cre_Cancel {
WebDriver driver;
	...
	//@Test
	@Given ("Select Cancel button from Favoritelist creration of Trendchart screen")
	public void Engineovw() throws Exception {
		...
		st.Trendicon();
		Thread.sleep(3000);	
		st.Favoritelist_creation_cancel();
		Thread.sleep(8000);
		System.out.print("Favoritelist is creation is cancelled");
