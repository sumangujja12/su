...
public class Fastdata_EditNote {
WebDriver driver;
	...
	@Given ("Select Edit Notes option from Favorite chart in Fastdatachart screen")
	public void Engineovw() throws Exception {
		...
		st.selectNotesInGraph();
		Thread.sleep(8000);
		st.selectNoteOptionsE();
		Thread.sleep(8000);
		st.selectNoteOptionsR();
		Thread.sleep(8000);
		st.selectNoteOptionsD();
		Thread.sleep(8000);
		driver.close();
