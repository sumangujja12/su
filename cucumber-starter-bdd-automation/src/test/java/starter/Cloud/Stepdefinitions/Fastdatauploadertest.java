...
public class Fastdatauploadertest {
WebDriver driver;
	...
	//@Test
	@Given ("Select Fastdata uploader icon form Left side menu")
	public void Engineovw() throws Exception {
		...
		sp.submitLogin();
		Thread.sleep(30000);
		Fastdatauploaderpage st=new Fastdatauploaderpage(driver);
		st.Fdatauploadericon();
		Thread.sleep(5000);	
		//st.favoritedata();
		//Thread.sleep(5000);
