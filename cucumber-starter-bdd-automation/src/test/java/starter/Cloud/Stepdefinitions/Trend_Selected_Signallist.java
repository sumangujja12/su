...
public class Trend_Selected_Signallist {
WebDriver driver;
	...
	@Given ("Select Plus icon from Trendchart screen")
	public void Trend_Signal() throws Exception {
		...
		st.favoriteTrend();
		Thread.sleep(8000);
		st.SelectedSignallist();
		Thread.sleep(8000);
		System.out.print("Selected Signal List is opened");
