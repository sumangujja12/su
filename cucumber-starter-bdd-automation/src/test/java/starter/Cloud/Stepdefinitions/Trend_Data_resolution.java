...
public class Trend_Data_resolution {
WebDriver driver;
	...
	@Given ("Select Data Resolution from Trendchart screen")
	public void Engineovw() throws Exception {
		...
		st.favoriteTrend();
		Thread.sleep(8000);
		st.Datapoint_Resolution();
		Thread.sleep(8000);
		System.out.print("Data point resolution is Selected");
