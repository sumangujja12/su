...
public class Favorite_Anglle_user_GET {
	@When("Verify the Favourite for Angle GET Rerquest for specific user")
	public void vessel() throws FileNotFoundException{
		...
		Response response=request.header("Content-Type","application/json").header("user_id","12345").header("type","angle").header("Authorization",accesstoken).get("/api/v2.1/favourite");
