...
public class Powercurves {
	@When("Powercurves API Post Rerquest")
	public void vessel1() throws FileNotFoundException{
		...
		File f= new File("powercurves.json");
		...
		Response response=request.body(ob.toString()).header("Content-Type","application/json").header("Authorization",accesstoken).post("/api/v2.1/powercurves");
