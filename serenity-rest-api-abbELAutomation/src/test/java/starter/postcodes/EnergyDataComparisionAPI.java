...
public class EnergyDataComparisionAPI {
    ...
    public void getData(){
        Response response = SerenityRest.given()
                ...
                .queryParam("widgetId","00966186-fc4b-4b5f-9bab-02512caf6b05")
                .headers(
                        "Authorization",
                        "Bearer "+Token,
                        "Accept",
                ...
                .get("https://electrificationapi-aps-stage-01.azurewebsites.net/api/plants/77903d8a-ba6e-4510-b1bb-d96f415f2120/widget/00966186-fc4b-4b5f-9bab-02512caf6b05?isOptions=true&plantType=EDCS&isPageEnabled=true&page=1&pageSize=14")
                .then()
                .extract()
                .response();
