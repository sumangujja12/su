...
public class ComparisonMultifactCurrent {
	String exlpath = "C:\\Environment\\EnvironmentParameters.xls";
	String outpath = "C:\\ABBOutput\\APITestCurrentWave2.xls";
	...
	//@Test
	@Given("To verify the Current widget for Wave 2 multifactor Comparison")
	public void multifactorCurrentWave2() throws IOException {
		...
		widget = XLUtils.getCellData(exlpath, "Wave2", 36, 1);
		...
		else if(testEnv.equalsIgnoreCase("GlobalStage"))
		{
			...
			widget = XLUtils.getCellData(exlpath, "Wave2", 24, 1);
		...
		else if(testEnv.equalsIgnoreCase("GlobalProduction"))
		{
			...
			widget = XLUtils.getCellData(exlpath, "Wave2", 48, 1);
